...
package Stocks_Materiel is
    ...
    type Tab_Stock is limited private;
...
private
    type T_Materiel is record 
                  ...
                  Annee_Achat  : Integer;
                  Etat         : T_Etat;
                  --Invariant : Numero_Serie > 0, Annee_Achat > 0
        end record;
        
        type Tab_Stock is array (1..CAPACITE) of T_Materiel;
        
        type T_Stock is record
                  Elements : Tab_Stock;
                  Taille : Integer;
                  -- Invariant : Taille >= 0 et Taille <= CAPACITE
        end record;
