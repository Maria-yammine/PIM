...
procedure Specifier_Et_Tester is
    ...
    -- Est-ce que le corps de cette procédure est correct ?  Pourquoi ? Non, les valeurs de 0 et 10 doivent être remplacées par des variables
    ...
    begin
        ...
        pragma Assert (21  = Pgcd (105, 147));  -- un autre
    end Tester_Pgcd;
