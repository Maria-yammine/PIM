...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_scenario_chainage" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#89ef78a6#;
   pragma Export (C, u00001, "scenario_chainageB");
   ...
   u00103 : constant Version_32 := 16#9b3c79ff#;
   pragma Export (C, u00103, "ensembles_chainageB");
   u00104 : constant Version_32 := 16#42b1abe8#;
   pragma Export (C, u00104, "ensembles_chainageS");
   ...
   u00108 : constant Version_32 := 16#b3ec9def#;
