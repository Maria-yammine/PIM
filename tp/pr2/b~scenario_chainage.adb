pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~scenario_chainage.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~scenario_chainage.adb");
...
package body ada_main is
   ...
   E104 : Short_Integer; pragma Import (Ada, E104, "ensembles_chainage_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_scenario_chainage");
