...
procedure Exemples_Memoire_Dynamique is
	...
	begin
		...
		-- XXX Quelle est la valeur de Ptr2.all ?   5 (ou 0)
		...
		-- XXX Que se passe-t-il si on exécute le programme avec valkyrie ? Valkyrie ne pourra pas executer le programme à cause cette erreur
		--
